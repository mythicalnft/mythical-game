...
module.exports = async (req, res) => {
    try {
        // Configurar encabezados de CORS (por si decides usar GitHub Pages de nuevo)
        ...
        const blockfrost = new Blockfrost({
            projectId: process.env.BLOCKFROST_API_KEY || 'preprodYnFO7lfgPJlgJSvXbCnh8LspzVzOYUu0', // Usa variable de entorno si está definida
            network: 'preprod'
        });
